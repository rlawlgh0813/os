...
xv6 교육용 운영체제를 기반으로 **시스템 콜(System Call)을 직접 설계·구현·검증**하며 사용자 공간과 커널 공간 간의 인터페이스, 트랩 처리 흐름, 프로세스 메타데이터 접근 방식을 학습한 프로젝트입니다.
...
이를 통해 **시스템 콜의 기본 구조**를 처음부터 끝까지 직접 연결했습니다.
...
> 단순히 “함수 추가”가 아니라,  
> xv6가 의도한 **일관된 시스템 콜 경로에 새 항목을 정확히 연결**하는 데 집중했습니다.
